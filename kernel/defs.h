...
void            kvmmap_(pagetable_t, uint64, uint64, uint64, int);
...
int             sync_pagetable(pagetable_t upagetable, pagetable_t kpagetable, uint64 oldsz, uint64 newsz, int append);
#endif
